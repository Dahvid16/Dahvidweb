...
const NavBar = () => {
  ...
  return (
    <nav className='lg:hidden flex flex-row bg-linear-to-r from-emerald-200 to-emerald-100 justify-between px-6 py-3 shadow-md items-center'>
        ...
        {isMenuOpen && (
        <>
        <motion.ul className='absolute top-17 flex flex-col bg-linear-to-l from-emerald-200 to-emerald-100 left-0 space-y-2 w-[60%] items-center py-3 px-8 shadow-md'
