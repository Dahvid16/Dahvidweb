      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/projects"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 gradient-primary text-primary-foreground rounded-2xl font-semibold shadow-emerald-lg hover:shadow-emerald transition-all duration-300 glow-hover"
              >
                View My Work
